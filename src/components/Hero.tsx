  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(50%_50%_at_50%_50%,rgba(0,0,0,0)_0%,rgba(0,0,0,0.04)_100%)]" />
      </div>
      ...
      <div className="container mx-auto px-4 py-20 md:py-32 flex flex-col items-center text-center z-10 reveal-on-scroll">
        ...
        <h1 className="text-5xl md:text-7xl font-display font-bold tracking-tight mb-6 animate-fade-in [animation-delay:400ms]">
          Alexandra <br /> Coleman
        </h1>
        
        <p className="max-w-xl text-lg md:text-xl text-muted-foreground mb-8 animate-fade-in [animation-delay:600ms]">
          Olympic gold medalist sharing the mindset of champions through her new book and motivational speeches.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 mt-4 animate-fade-in [animation-delay:800ms]">
          <Button 
            size="lg" 
            className="rounded-full px-8 py-6 font-medium text-base shadow-sm hover:shadow-md transition-all duration-300"
          >
            Get the Book
          </Button>
          ...
          <Button 
            variant="outline" 
            size="lg" 
            className="rounded-full px-8 py-6 font-medium text-base bg-white/50 backdrop-blur-sm hover:bg-white/80 transition-all duration-300"
          >
            Book a Speech
          </Button>
        </div>
      ...
      <div className="absolute bottom-12 left-0 right-0 flex justify-center animate-fade-in [animation-delay:1200ms]">
        <button 
          ...
          className="rounded-full w-10 h-10 flex items-center justify-center border border-muted hover:border-primary transition-colors duration-300"
